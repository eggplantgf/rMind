...
기존 AI 면접 플랫폼들은 텍스트·음성 위주의 평가에 집중하여, 표정이나 시선 같은 **비언어적 요소**를 놓치는 한계가 존재함.  
rMind는 이러한 문제를 해결하기 위해 **별도의 장비 없이 스마트폰 카메라만으로(비접촉식 rPPG)** 생체 신호를 정밀하게 분석.  
이를 통해 사용자는 자신의 긴장도와 태도를 객관적으로 파악하고, 스스로 면접 역량을 강화할 수 있는 환경 제공.
...
- **Excellence Prize**, University Capstone Design Competition (2025, KRW 1,000,000)
